...
> 11 |     await expect(page.locator("p.text-sm font-semibold text-center")).toHaveText('Harini');
     |                                                                       ^ Error: expect(locator).toHaveText(expected) failed
  12 |     await expect(page.locator("p.text-sm font-semibold text-center")).toHaveText('Raja');
  13 | })
  14 | 
```