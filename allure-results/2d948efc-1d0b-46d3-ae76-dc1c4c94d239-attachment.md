...
- main:
  ...
  - insertion:
    - text: Discover more
    - link "Automation Strategy Consulting":
      - img
    ...
    - link "Test Automation Training":
      - img
      - text: Test Automation Training
    - link "Web Browsers":
      - img
      - text: Web Browsers
    - link "Educational Course Development":
      - img
      - text: Educational Course Development
...
- insertion:
  - iframe
- img
- link "Go to shopping options for Automation Engineer Training": Automation Engineer Training
...
> 12 |     await expect(page.locator("p.text-sm font-semibold text-center")).toHaveText('Sample');
     |                                                                       ^ Error: expect(locator).toHaveText(expected) failed
  13 |     await expect(page.locator("p.text-sm font-semibold text-center")).toHaveText('1');
  14 | })
```